...
import br.com.daysesoares.helpdesk.api.entity.ChangeStatus;
import br.com.daysesoares.helpdesk.api.entity.Ticket;
import br.com.daysesoares.helpdesk.api.repository.ChangeStatusRepository;
import br.com.daysesoares.helpdesk.api.repository.TicketRepository;
import br.com.daysesoares.helpdesk.api.service.TicketService;
...
public class TicketServiceImpl implements TicketService {
	...
	public Page<Ticket> findByCurrentUser(int page, int count, String userId) {
		PageRequest pages = PageRequest.of(page, count);
		return ticketRepository.findByUserIdOrderByDateRegistrationDesc(userId, pages);
	}

	@Override
	public Page<Ticket> findByParameters(int page, int count, String title, String status, String priority) {
		PageRequest pages = PageRequest.of(page, count);
		return ticketRepository.findByTitleIgnoreCaseContainingAndStatusAndPriorityOrderByDateRegistrationDesc(title, status, priority, pages);
	}
	...
	public Page<Ticket> findByParametersAndCurrentUser(int page, int count, String title, String status,
		...
		PageRequest pages = PageRequest.of(page, count);
		return ticketRepository.findByTitleIgnoreCaseContainingAndStatusAndPriorityAndUserIdOrderByDateRegistrationDesc(title, status, priority, userId, pages);
	}
